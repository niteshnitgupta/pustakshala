...
<div id="works"  class=" clearfix grid">
    <figure class="effect-oscar  wowload fadeIn search">
        <img src="images/portfolio/1.jpg" alt="img01"/>
        <figcaption>
            <h2>Philosophy</h2>
            <p><br /><br /><br />You can find lots of asfdsfsdf sdfsdfdsf</p>
        </figcaption>
    </figure>
     <figure class="effect-oscar  wowload fadeInUp search">
    ...
    <figure class="effect-oscar  wowload search">
